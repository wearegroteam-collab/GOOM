...
create policy "Admins upload GOOM images" on storage.objects for insert to authenticated with check (bucket_id in ('events','gallery','services'));
drop policy if exists "Admins update GOOM images" on storage.objects;
create policy "Admins update GOOM images" on storage.objects for update to authenticated using (bucket_id in ('events','gallery','services')) with check (bucket_id in ('events','gallery','services'));
drop policy if exists "Admins delete GOOM images" on storage.objects;
create policy "Admins delete GOOM images" on storage.objects for delete to authenticated using (bucket_id in ('events','gallery','services'));
