...
export type PaymentWebhookEventRecord = { id: string; provider: string; provider_event_id: string; event_type: string; environment: "sandbox"|"production"; payload: Record<string, unknown>; processed_at: string|null; processing_error: string|null; created_at: string };
